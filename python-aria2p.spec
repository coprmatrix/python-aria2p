#
# spec file for package python-aria2p
#
...
License:        ISC
URL:            https://pawamoy.github.io/aria2p
Source:         aria2p-%{version}.tar.gz
...
BuildRequires:  %{python_module requests >= 2.19}
BuildRequires:  %{python_module websocket-client >= 0.58}
# /SECTION
BuildRequires:  fdupes
Requires:       python-loguru >= 0.5
Requires:       python-platformdirs >= 4.2
Requires:       python-requests >= 2.19
Requires:       python-websocket-client >= 0.58
Suggests:       python-asciimatics >= 1.13
Suggests:       python-pyperclip >= 1.8
BuildArch:      noarch
%python_subpackages
...
%install
%pyproject_install
%python_clone -a %{buildroot}%{_bindir}/aria2p
%python_expand %fdupes %{buildroot}%{$python_sitelib}

%post
%python_install_alternative aria2p

%postun
%python_uninstall_alternative aria2p

%files %{python_files}
%doc README.md
%license LICENSE
%python_alternative %{_bindir}/aria2p
%{python_sitelib}/aria2p
%{python_sitelib}/aria2p-%{version}.dist-info
